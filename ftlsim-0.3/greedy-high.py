...
for i in range(20):
    ...
    print ftl.ext_writes, ftl.int_writes, (1.0*ftl.int_writes)/ftl.ext_writes, ftl.wl_counts, (1.0*ftl.wl_counts)/ftl.ext_writes, (1.0*ftl.wl_counts+ftl.int_writes)/ftl.ext_writes
